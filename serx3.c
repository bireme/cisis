...
//wtrig2=on&c=xLILACS&port=1818&minsim=0.40&text=SUS%20UNIC
#if 0
./serx "force=wtrig2=on c=xLILACS port=1818 minsim=0.40 text=SUS%20UNIC"

./serx "force=wtrig2=on c=xLILACS port=1715 minsim=0.40 text=SUS%20UNIC"

./serwx port=1715 cipar=serw.cip tell

cd ..
./serx port=1715 "wtrig2 c=xLILACS minsim=0.70 maxrel=200 tell=1 text=AIEPI"

./serx port=1714 "wtrig2 c=xLILACS minsim=0.10 maxrel=10 tell=1 trace1 text=AIEPI"

./serx port=1714 "wtrig2 c=xLILACS minsim=0.10 maxrel=200 tell=1 text=AIEPI"

./serx port=1714 "wtrig2 c=xLILACS minsim=0.10 maxrel=200 tell=1 text=AIEPI"
wtrig2=on&c=xLILACS&port=1714&minsim=0.30&maxrel=8&text=diabetes%20melli

"wtrig2 c=xLILACS minsim=0.10 maxrel=200 tell=1 text=AIEPI"

http://serverofi.bireme.br/cgi-bin/similar/serc?wtrig2=on&port=1715&c=xLILACS&text=AIEPI&maxrel=50&minsim=0.30
http://serverofi.bireme.br/cgi-bin/serx?wtrig2=on&port=1714&c=xLILACS&text1=.&text=AIEPI&maxrel=10&minsim=0.30
 

export REQUEST_METHOD=GET
export QUERY_STRING="port=1715&wtrig2=on&c=xLILACS&minsim=0.10&maxrel=10&tell=1&&text=AIEPI"
./serx 




./serc port=1714 "wtrig2 c=xLILACS minsim=0.10 maxrel=20 tell=1 text=AIEPI"

./serx port=1714 "wtrig2 c=xLILACS minsim=0.10 maxrel=20 tell=1 text=AIEPI"

http://serverofi.bireme.br/cgi-bin/serx?port=1715&wtrig2=on&c=xLILACS&minsim=0.10&maxrel=20&tell=1&text=AIEPI

 cd similar/
 ./serc port=1715 "wtrig2 c=xLILACS minsim=0.10 maxrel=20 tell=1 trace1 text=AIEPI"
 cd ..
 ./serx port=1715 "wtrig2 c=xLILACS minsim=0.10 maxrel=20 tell=1 text=AIEPI"


nohup ./serwx port=1727 cipar=serw.cip tell &
sleep 1
cd ..
./serx port=1727 "wtrig2 c=xLILACS minsim=0.10 maxrel=27 tell=1 text=AIEPI"
cd similar

http://serverofi.bireme.br/cgi-bin/serx?port=1727&wtrig2=on&c=xLILACS&minsim=0.01&maxrel=50&tell=1&text=AIEPI
...
//            }
            ...
            *buffer='\0';            
            ...
            if (!pcmdp) if (!procp) if (!pftxp) {
                ...
                int occ=1;
                int oc2=occ;
                if (dbtag>0) tag=dbtag;
                if (dbocc>0) {occ=dbocc; oc2=occ;}
                if (dboc2>0) {oc2=dboc2; if (oc2<occ) oc2=occ;}
                for (; occ <= oc2; occ++) {
...
<!--
<option value="DeCS^         ^vc:\fsp\decs\decs^         ^cc:\fsp\fapd^               ^tconcepts^  ^iDescritores em Ci&ecirc;ncias da Sa&uacute;de">DeCS</option>
<option value="DeCSap^       ^vc:\fsp\decs\decs^         ^cc:\fsp\fapdtk^             ^tconcepts^  ^iDescritores em Ci&ecirc;ncias da Sa&uacute;de / 1+1+50">DeCSap</option>
<option value="LILACStk^     ^vc:\ofix\lilacs^           ^cc:\ofix\rel.lil\m3ff^      ^tarticles^  ^iLiteratura Latino-Americana e do Caribe em Ciências da Saúde / TI+JD+87">LILACStk</option>
<option value="LILACSaids^   ^vc:\fapesp\aids\list_aids^ ^cc:\fapesp\aids\xlilaids^   ^tarticles^  ^iLiteratura Latino-Americana e do Caribe em Ciências da Saúde / AIDS / TI+AB">LILACSaids</option>
<option value="LILACSaidstk^ ^vc:\fapesp\aids\list_aids^ ^cc:\fapesp\aids\xlilaidstk^ ^tarticles^  ^iLiteratura Latino-Americana e do Caribe em Ciências da Saúde / AIDS / TI+KW">LILACSaidstk</option>
<option value="MEDLINEaids^  ^vc:\fapesp\regina\medline_aids^ ^cc:\fapesp\regina\xmdlaids^   ^tarticles^  ^iNational Library of Medline MEDLINE / AIDS / TI[+AB]">MEDLINEaids</option>
<option value="MEDLINEaidstk^^vc:\fapesp\regina\medline_aids^ ^cc:\fapesp\regina\xmdlaidstk^ ^tarticles^  ^iNational Library of Medline MEDLINE / AIDS / TI+KW">MEDLINEaidstk</option>
<option value="SciELO^       ^vc:\ofix\xart^             ^cc:\ofix\xartha1^           ^tarticles^  ^iScientific Electronic Library Online / TI+KW+AB">SciELO</option>
<option value="SciELOtk^     ^vc:\ofix\xart^             ^cc:\ofix\xartha1tk^         ^tarticles^  ^iScientific Electronic Library Online / TI+KW">SciELOtk</option>
<option value="InstCNPq^     ^vc:\ofix\co-lil\instv2^    ^cc:\ofix\co-lil\instv4ff^         ^tinstitutions^  ^iTabela de Instituições do CNPq/Lattes">InstCNPq</option>
 -->

<option value="VisaLegis.Summary^d1901">VisaLegis - Summary</option>
<option value="SciELO.br">SciELO Brasil - Autor/T&iacute;tulo</option>
<option value="LILACS">LILACS Regional - T&iacute;tulo/JDs/Descritores</option>
<option value="SciELO.br.TiKw^p1717" selected>SciELO Brasil -T&iacute;tulo/Keywords</option>

<option value="DeCS.i^p1701">DeCS Inglês - Termo/Sinônimos/Históricos</option>
<option value="DeCS.e^p1702">DeCS Espanhol - Termo/Sinônimos/Históricos</option>
<option value="DeCS.p^p1703">DeCS Português - Termo/Sinônimos/Históricos</option>
<option value="DeCS.c^p1704">DeCS Hierárquico - Códigos hierárquicos</option>

OFI:/home/galvao/www/site/bvs/cgi-bin/similar>./psw
cdrom    12574     1  0 Oct07 ?        00:02:21 ./serw port=1701 cipar=serw.cip
cdrom    12579     1  0 Oct07 ?        00:00:15 ./serw port=1702 cipar=serw.cip
cdrom    12596     1  0 Oct07 ?        00:00:15 ./serw port=1703 cipar=serw.cip
cdrom    12607     1  0 Oct07 ?        00:00:12 ./serw port=1704 cipar=serw.cip
cdrom    20968     1  0 Oct07 ?        00:00:31 ./serw port=1717 cipar=serw.cip  SciELO.br.TiKw
cdrom     8116     1  0 Oct10 ?        00:00:00 ./serw port=1900 cipar=serw.cip  
cdrom    11861     1 71 20:28 pts/2    00:03:50 ./serw port=1417 cipar=serw.cip  SciELO.br        LILACS
cdrom    12028 12020  0 20:33 pts/2    00:00:00 grep serw

http://serverofi.bireme.br/cgi-bin/serx?wtrig2=on&c=SciELO.br&tagtext=v10^n,x1,v10^s,x1,v12^*&db=SciELO.br&mfn=20197&pft=all

http://serverofi.bireme.br/cgi-bin/serx?wtrig2=onx&c=SciELO.br.TiKw&port=1717&minsim=0.30&db=SciELO.br&pft=all&tagtext=v12[1]^*&mfn=4

...
id2i: id2i.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld id2i..
	$(CC) -o id2i id2i.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

id2i.o: id2i.c cisis.h
	echo id2i..
	$(CC) $(CCOPTS) id2i.c

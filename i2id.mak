...
i2id: i2id.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld i2id..
	$(CC) -o i2id i2id.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

i2id.o: i2id.c cisis.h
	echo i2id..
	$(CC) $(CCOPTS) i2id.c

...
echo mkdir utl/linux64/ffiG4_4   >mkffiG4_4_64.sh
...
./mx seq=xls "pft='sh -x mxmake64.sh utl/linux64/ffiG4_4   'left(v1,size(v1)-4)' CIFFI=1 LIND=1 LIND4=1 ISISXL=1 ISISXL512=0  SIXTY_FOUR=1 _FILE_OFFSET_BITS=64 _LARGEFILE64_SOURCE=1 MAXMFRL=4194304'/" lw=0 now >>mkffiG4_4_64.sh
...
echo          mv utl/linux64/ffiG4_4/ifload utl/linux64/ffiG4_4/iflind       >>xmk.sh
...
echo          rm utl/linux64/ffiG4_4/ifupd      >>xmk.sh
echo          rm utl/linux64/ffi512/ifupd       >>xmk.sh
echo          rm utl/linux64/ffi512G4/ifupd     >>xmk.sh

echo          rm utl/linux64/isis/wtrig*            >>xmk.sh
echo          rm utl/linux64/isis1660/wtrig*        >>xmk.sh
echo          rm utl/linux64/isisG/wtrig*           >>xmk.sh
echo          rm utl/linux64/lind/wtring*           >>xmk.sh
echo          rm utl/linux64/lindG4/wtrig*          >>xmk.sh
echo          rm utl/linux64/lind512/wtrig*         >>xmk.sh
echo          rm utl/linux64/lind512G4/wtrig*       >>xmk.sh
...
echo          mkdir wxis/linux64/ffiG4_4                     >>xmk.sh
...
echo          cp utl/linux64/isisG/wxis wxis/linux64/isisG               >>xmk.sh
...
echo          cp utl/linux64/ffiG4_4/wxis wxis/linux64/ffiG4_4          >>xmk.sh

...
#CICONF1 = -DCIFFI=$(CIFFI) -DLIND=$(LIND) -DLIND4=$(LIND4) -DISISXL=$(ISISXL) -DISISXL512=$(ISISXL512) -DLINDLUX=$(LINDLUX)
...
ifload: ifload.o ifloadao.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciupi.o ciutl.o ciifl.o
	echo ld ifload..
	$(CC) -o ifload ifload.o ifloadao.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciupi.o ciutl.o ciifl.o $(CCLIBS)

ifloadao.o: ifloadao.c cisis.h
	echo ifloadao..
	$(CC) $(CCOPTS) ifloadao.c

ifload.o: ifload.c cisis.h
	echo ifload..
	$(CC) $(CCOPTS) ifload.c

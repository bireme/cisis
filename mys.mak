...
mys: mys.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciupi.o ciutl.o ciifl.o
	echo ld mys..
	$(CC) -o mys mys.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciupi.o ciutl.o ciifl.o $(CCLIBS)

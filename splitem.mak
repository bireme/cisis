...
splitem: splitem.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o
	echo ld splitem..
	$(CC) -o splitem splitem.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o $(CCLIBS)

splitem.o: splitem.c cisis.h
	echo splitem..
	$(CC) $(CCOPTS) splitem.c

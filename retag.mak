...
retag: retag.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld retag..
	$(CC) -o retag retag.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

retag.o: retag.c cisis.h
	echo retag..
	$(CC) $(CCOPTS) retag.c

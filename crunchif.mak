...
crunchif: crunchif.o cidbx.o cigiz.o cirec.o ciupd.o ciutl.o citrm.o
	echo ld crunchif..
	$(CC) -o crunchif crunchif.o cidbx.o cigiz.o cirec.o ciupd.o ciutl.o citrm.o $(CCLIBS)

crunchif.o: crunchif.c cisis.h
	echo crunchif..
	$(CC) $(CCOPTS) crunchif.c

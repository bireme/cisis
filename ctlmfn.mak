...
ctlmfn: ctlmfn.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld ctlmfn..
	$(CC) -o ctlmfn ctlmfn.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

ctlmfn.o: ctlmfn.c cisis.h
	echo ctlmfn..
	$(CC) $(CCOPTS) ctlmfn.c

...
echo mkdir utl/linux/ffiG4_4    >mkffiG4_4.xsh
...
./mx seq=xls "pft='sh -x mxmake32.xsh utl/linux/ffiG4_4    'left(v1,size(v1)-4)' CIFFI=1 LIND=1 LIND4=1 ISISXL=1 ISISXL512=0 _FILE_OFFSET_BITS=64 _LARGEFILE64_SOURCE=1 MAXMFRL=4194304 '/" lw=0 now >>mkffiG4_4.xsh
...
echo          mv utl/linux/lindG4_4/ifload utl/linux/lindG4_4/iflind   >>xmk.xsh
...
echo          rm utl/linux/ffiG4_4/ifupd    >>xmk.xsh
...
echo          mkdir wxis/linux/ffiG4_4      >>xmk.xsh
...
echo          cp utl/linux/ffiG4_4/wxis wxis/linux/ffiG4_4      >>xmk.xsh

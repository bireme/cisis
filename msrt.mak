...
msrt: msrt.o cifm1.o cifm2.o cifm3.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld msrt..
	$(CC) -o msrt msrt.o cifm1.o cifm2.o cifm3.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

msrt.o: msrt.c cisis.h
	echo msrt..
	$(CC) $(CCOPTS) msrt.c

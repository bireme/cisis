...
mxcp: mxcp.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld mxcp..
	$(CC) -o mxcp mxcp.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

mxcp.o: mxcp.c cisis.h
	echo mxcp..
	$(CC) $(CCOPTS) mxcp.c

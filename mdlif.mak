...
mdlif: mdlif.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld mdlif..
	$(CC) -o mdlif mdlif.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

mdlif.o: mdlif.c cisis.h
	echo mdlif..
	$(CC) $(CCOPTS) mdlif.c

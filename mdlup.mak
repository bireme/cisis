...
mdlup: mdlup.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld mdlup..
	$(CC) -o mdlup mdlup.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

mdlup.o: mdlup.c cisis.h
	echo mdlup..
	$(CC) $(CCOPTS) mdlup.c

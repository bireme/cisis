...
decs9a: decs9a.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld decs9a..
	$(CC) -o decs9a decs9a.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

decs9a.o: decs9a.c cisis.h
	echo decs9a..
	$(CC) $(CCOPTS) decs9a.c

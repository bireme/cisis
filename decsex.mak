...
decsex: decsex.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld decsex..
	$(CC) -o decsex decsex.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

decsex.o: decsex.c cisis.h
	echo decsex..
	$(CC) $(CCOPTS) decsex.c

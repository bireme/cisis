...
asael1: asael1.o cib71.o cib72.o  cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld asael1..
	$(CC) -o asael1 asael1.o cib71.o cib72.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

asael1.o: asael1.c cisis.h
	echo asael1..
	$(CC) $(CCOPTS) asael1.c

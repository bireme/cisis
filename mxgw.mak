...
mxgw: mxgw.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld mxgw..
	$(CC) -o mxgw mxgw.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o $(CCLIBS)

mxgw.o: mxgw.c cisis.h
	echo mxgw..
	$(CC) $(CCOPTS) mxgw.c

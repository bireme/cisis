...
mxf0: mxf0.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o
	echo ld mxf0..
	$(CC) $(CCLIBS) -o mxf0 mxf0.o cidbx.o cigiz.o cirec.o ciupd.o citrm.o ciutl.o

mxf0.o: mxf0.c cisis.h
	echo mxf0..
	$(CC) $(CCOPTS) mxf0.c
